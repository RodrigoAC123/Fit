...
st.image(
    "FIT.jpg",
    caption="Ser fit toma en cuenta múltiples variables para clasificar si realmente lo eres, o no."
)
...
def user_input_features():
    ...
    heart_rate = st.number_input(
        "Escribe tu frecuencia cardiaca promedio en reposo (la media está entre 70-90):",
        min_value=40,
        max_value=180,
        value=75,
        step=1
    ...
    blood_pressure = st.number_input(
        "Escribe tu presión arterial (la media está entre 80-140):",
        min_value=70,
        max_value=180,
        value=120,
        step=1
    ...
    nutrition_quality = st.number_input(
        "¿Qué tan bien comes del 1 al 10?",
        min_value=1,
        max_value=10,
        value=5,
        step=1
